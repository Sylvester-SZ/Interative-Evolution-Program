...
void algoritme_kamp(int algoritme1, int algoritme2, int runder) { //kan laves til at returnere en tabel i stedet for at opdatere hvis man vil lave multithreading i en større evolutionssimulation

  for (int i = 0; i < runder; i++) { //kør antallet af runder, eksempelvis 12
